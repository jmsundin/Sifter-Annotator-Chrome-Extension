...
(function (M, q) {
  ...
  function T(a, b, d, f) {
    ...
    if (Array.isArray(a))
      ...
      for (a = h.call(a), g = 0; !(c = a.next()).done; )
        (c = c.value), (h = b + U(c, g++)), (e += T(c, h, d, f));
    else
      "object" === c &&
        ((d = "" + a),
        q(
  ...
  if (e && e._schedMock) {
    ...
    D = function (a, b) {
      null !== v ? setTimeout(D, 0, a) : ((v = a), setTimeout(Oa, 0, !1));
    };
    O = function () {
      v = null;
    };
    ...
    var aa = function (a) {
      if (null !== w) {
        Y(aa);
        var b = a - K + B;
        b < B && L < B ? (8 > b && (b = 8), (B = b < L ? L : b)) : (L = b);
        K = a + B;
        J || ((J = !0), sa.postMessage(void 0));
      } else A = !1;
    };
    D = function (a, b) {
      w = a;
  ...
  var Pa = 0,
    ma = { current: null },
    R = { current: null };
  e = { ReactCurrentDispatcher: ma, ReactCurrentOwner: R, assign: I };
  I(e, {
    Scheduler: {
  ...
  r = {
    ...
    createContext: function (a, b) {
      ...
      a.Provider = { $$typeof: Ba, _context: a };
      return (a.Consumer = a);
    },
